...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  useEffect(() => {
    ...
    // 로그인 후에도 접근 가능한 페이지들
    const allowedRoutes = ['design-showcase', 'search', 'search-results', 'notifications', 'settings', 'profile-edit', 'recipe', 'recipe-create-manual', 'shopping-list', 'recipe-book-detail', 'group-recipe-books', 'group-members', 'group-edit', 'group-feed-create'];
