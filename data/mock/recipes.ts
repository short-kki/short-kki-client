...
export const MOCK_RECIPE_BOOK_RECIPES: Record<string, Recipe[]> = {
  default: [
    { id: "1", title: "토마토 파스타", thumbnail: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400", duration: "20분", author: "요리왕", bookId: "default" },
    { id: "2", title: "김치볶음밥", thumbnail: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400", duration: "15분", author: "백종원", bookId: "default" },
    { id: "3", title: "된장찌개", thumbnail: "https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=400", duration: "25분", author: "집밥선생", bookId: "default" },
    { id: "4", title: "계란말이", thumbnail: "https://images.unsplash.com/photo-1525351484163-7529414344d8?w=400", duration: "10분", author: "간편요리", bookId: "default" },
    { id: "5", title: "불고기", thumbnail: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400", duration: "30분", author: "한식마스터", bookId: "default" },
    { id: "6", title: "샐러드", thumbnail: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=400", duration: "10분", author: "헬시쿡", bookId: "default" },
  ],
  "1": [
